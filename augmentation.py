'''Augmentation to image for generator'''
...
def random_hsv(X, hue_shift_limit=(-180, 180),
    ...
    '''Apply hue_shift, sat_shift, val_shift
    # Arguments
      hue_shift_limit
      sat_shift_limit
      val_shift_limit
...
def aug(X, y):
    '''the main method of augmentation
    # Arguments
      X...train images
      y...GroundTruth images
    # Returns
      X, y...train/GT images augmentated
    '''
    gamma = random.uniform(0.8, 1.2)
    X = adjust_gamma(X, gamma)
    X, y = random_rotation(X, y, rg=180)
